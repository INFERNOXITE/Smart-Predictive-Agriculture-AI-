...
> 📌 **Note:** Apache 2.0 also grants an express patent license from contributors to users, and requires that any modified files carry prominent notices stating the changes made. Be sure to add a corresponding `LICENSE` file (containing the full Apache 2.0 text) to the root of your repository.
